...
$querry = "update company_profile SET comName ='$comName',comYOE='$comYOE',comType='$comType',comEmail='$email',comSite='$comSite',comLink='$comLink',comOffice='$comOffice',comAbout='$comAbout' Where username = '$email'";
$result = mysqli_query($con,$querry);
header("Location: http://localhost/JOB-PORTAL/company.php");
